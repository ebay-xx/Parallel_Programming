...
echo "Executing CoinFlip with 3 thread for 10000000 coin flips"
for (( i=1; i<=5; i++ )); 
do java CoinFlip 3 10000000; 
done

echo "Executing CoinFlip with 3 thread for 20000000 coin flips"
for (( i=1; i<=5; i++ )); 
do java CoinFlip 3 20000000; 
done

echo "Executing CoinFlip with 3 thread for 30000000 coin flips"
for (( i=1; i<=5; i++ )); 
do java CoinFlip 3 30000000; 
done

echo "Executing CoinFlip with 3 thread for 40000000 coin flips"
for (( i=1; i<=5; i++ )); 
do java CoinFlip 3 40000000; 
done

echo "Executing CoinFlip with 3 thread for 50000000 coin flips"
for (( i=1; i<=5; i++ )); 
do java CoinFlip 3 50000000; 
done
...
echo "Executing CoinFlip with 3 thread for 200000000 coin flips"
for (( i=1; i<=5; i++ )); 
do java CoinFlip 3 200000000; 
done
...
echo "Executing CoinFlip with 3 thread for 400000000 coin flips"
for (( i=1; i<=5; i++ )); 
do java CoinFlip 3 400000000; 
done

echo "Executing CoinFlip with 3 thread for 500000000 coin flips"
for (( i=1; i<=5; i++ )); 
do java CoinFlip 3 500000000; 
done
